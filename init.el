...
(require 'org)
(org-babel-load-file
  (expand-file-name "settings.org" "/home/bu6hunt3r/Dokumente/using-emacs/"))
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Dokumente/using-emacs/settings.org")))
 '(package-selected-packages
   (quote
    (go-mode go-complete worf web-mode fzf ryo-modal modalka autopair wavefront-obj-mode frog-jump-buffer dumb-jump tickscript-mode company-jedi openwith undo-fu nand2tetris irony-eldoc undo-tree counsel swiper lorem-ipsum tabbar ace-window org-bullets which-key try use-package)))
